    ...
    <>
      <header className="fixed top-0 z-40 inset-x-0 lg:px-10 px-6 py-6">
        <nav className="flex items-center lg:item-start justify-between gap-x-6">
          <Link
            href="/"
            className="relative lg:text-4xl text-3xl font-black tracking-tighter text-transparent uppercase bg-clip-text bg-gradient-to-br from-yellow-400 to-green-700"
          >
            <h1 className="text-dm">Brasil Tube</h1>
          </Link>
          <button
