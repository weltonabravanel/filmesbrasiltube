export async function GET(request) {
  try {
    ...
    const url = `https://api.themoviedb.org/3/discover/movie?include_adult=true&include_video=false&language=pt-BR&page=${page}&sort_by=vote_count.desc&with_genres=${genre}'`;
    const options = {
      method: "GET",
      headers: {
